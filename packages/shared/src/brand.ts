...
export { publicExperiencePath, BRAND_ROOT_DOMAIN, BRAND_STUDIO_BASE, brandSlugFromHost, studioBasePath, studioPath, studioHomePath, publicExperienceBasePath } from "./digital-life-urls.js";
